...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '', title: 'App Movil', icon: 'bi bi-phone', class: 'sub', badge: '', badgeClass: '', isExternalLink: false, submenu: [
            { path: '/AppMovil/movimiento_almacen', title: 'Movimiento de Almacen', icon: 'bx bx-right-arrow-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            { path: '/AppMovil/vender_devolver', title: 'Vender / Devolver', icon: 'bx bx-right-arrow-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
